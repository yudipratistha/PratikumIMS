...
while True:
    ...
    # print(data_cursor_toko1[0], data_cursor_toko2[0])
    if (increment_toko[0]) > (increment_bank[0]):
        ...
        # print(increment_bank[0], increment_toko[0])
    ...
    # if (data_cursor_toko2[0] < data_cursor_bank2[0]):
    #     print(data_cursor_toko2, data_cursor_bank2)
    ...
    for row1 in data_transaksi_bank:
        ...
        if(delete == True):
         ...
         print("Tidak ada delete")
    # elif(data_cursor_bank1[0] > data_cursor_bank2[0]):
    #     print("Terjadi pengapusan data")
    #     sql_toko = "SELECT id_transaksi FROM tb_transaksi"
    #     sql_bank = "SELECT id_transaksi_toko FROM tb_transaksi_toko"
    #     cursor_toko.execute(sql_toko)
    #     cursor_bank.execute(sql_bank)
